...
export default class extends Controller {
  ...
  connect() {
    this._onContext = (e) => { e.preventDefault(); if (this.hasMenuTarget) { this.menuTarget.classList.remove("hidden"); this.menuTarget.style.left = `${e.offsetX}px`; this.menuTarget.style.top = `${e.offsetY}px` } }
