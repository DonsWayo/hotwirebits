...
export default class extends Controller {
  ...
  render() {
    ...
    this.tagsValue.forEach((tag) => {
      ...
      el.innerHTML = `${this.escapeHtml(tag)}<button type="button" data-action="click->rb-tags#removeTag" data-rb-tags-value-param="${this.escapeHtml(tag)}" aria-label="Remove ${this.escapeHtml(tag)}">&times;</button>`
