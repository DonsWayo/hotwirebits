      ...
      if @src
        ...
        tag.div(@initials,
                class: merge_classes(size_classes,
                                     'rounded-full bg-rb-muted flex items-center justify-center font-medium text-rb-muted-foreground'))
      else
        tag.div(class: merge_classes(size_classes,
                                     'rounded-full bg-rb-muted flex items-center justify-center text-rb-muted-foreground')) do
