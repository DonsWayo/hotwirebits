...
module RailsBits
  class ToastComponent < Base
    TYPES = {
      success: { bg: 'border-rb-success/30', icon: 'text-rb-success', default_title: 'Success' },
      error: { bg: 'border-rb-destructive/30', icon: 'text-rb-destructive', default_title: 'Error' },
      warning: { bg: 'border-rb-warning/30', icon: 'text-rb-warning', default_title: 'Warning' },
      info: { bg: 'border-rb-info/30', icon: 'text-rb-info', default_title: 'Info' }
    }.freeze
