...
module RailsBits
  class SearchInputComponent < Base
    ...
    def search_icon
      ...
      tag.div(class: merge_classes('absolute top-1/2 -translate-y-1/2 text-rb-muted-foreground',
    ...
    def clear_button
      tag.button(type: 'button',
                 class: 'absolute right-2 top-1/2 -translate-y-1/2 text-rb-muted-foreground hover:text-rb-foreground') do
